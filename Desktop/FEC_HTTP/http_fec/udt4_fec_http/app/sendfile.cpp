...
int main(int argc, char* argv[])
{
   ...
   UDT::setsockopt(serv, 0, UDT_SNDBUF, new int(1050000000), sizeof(int));
   UDT::setsockopt(serv, 0, UDP_SNDBUF, new int(1050000000), sizeof(int));
   ...
   //{
      ...
      //#ifndef WIN32
         ...
         if (argc == 4)      
            sendfile(new UDTSOCKET(fhandle), atoi(argv[2]), atoi(argv[3]));
         else
            sendfile(new UDTSOCKET(fhandle), 0, 0);
      //#else
...
#ifndef WIN32
void* sendfile(void* usocket, int row_rate, int col_rate)
#else
...
#endif
{
   ...
   if (row_rate > 0 && col_rate > 0) {
      UDT::setsockopt(fhandle, 0, UDT_FECROWRATE, new int(row_rate), sizeof(int));
      UDT::setsockopt(fhandle, 0, UDT_FECCOLRATE, new int(col_rate), sizeof(int));
   }
